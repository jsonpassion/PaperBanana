...
TRANSLATIONS = {
    "en": {
        ...
        "method_content_help": "The method section from the paper that describes the approach. Markdown format is recommended.",
        ...
        "caption_help": "The caption or description of the figure to generate. Markdown format is recommended.",
        ...
        "refine_caption": "Upload an image from the candidates or any diagram, describe changes, and generate a high-res version",
        ...
        "file_uploader_help": "Upload the diagram you want to refine",
        ...
        "edit_prompt_help": "Describe what you want to change or use 'Keep everything the same' for just upscaling",
    ...
    "ko": {
        ...
        "method_content_help": "논문의 접근 방식을 설명하는 방법론 섹션입니다. Markdown 형식을 권장합니다.",
        "load_example_caption": "예시 불러오기 (캡션)",
        "caption_label": "그림 캡션 (Markdown 권장)",
        "caption_placeholder": "그림 캡션을 입력하세요...",
        "caption_help": "생성할 그림의 캡션 또는 설명입니다. Markdown 형식을 권장합니다.",
        ...
        "refine_caption": "후보 또는 다이어그램을 업로드하고, 변경 사항을 설명한 뒤 고해상도 버전을 생성하세요",
        ...
        "file_uploader_help": "개선할 다이어그램을 업로드하세요",
        ...
        "edit_prompt_help": "변경하고 싶은 내용을 설명하거나, 업스케일만 원하면 '모든 것을 동일하게 유지'를 사용하세요",
